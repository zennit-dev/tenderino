import { CalendarIcon, LaptopChart, UsersIcon } from "@zennui/icons";
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex gap-4 px-4">
        <div className="border-r border-r-border flex-1 gap-8 flex flex-col pr-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-foreground-dimmed">
              ...
              comfort,
              <br />
              functionality, and aesthetic standards for day-to-day operations.
              Vendors must provide detailed product specifications (including
              materials, dimensions, and finishes), competitive pricing, and a
              clear delivery and installation timeline.
            </p>
          </div>
        ...
        <div className="border border-border h-fit pl-2 py-2 space-y-2 rounded-xl">
