...
export const CarouselPrevious = ({
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 rounded-full bg-primary/40 transition-colors hover:bg-primary",
        orientation === "horizontal"
      ...
      {...props}
    >
      <ArrowLeftIcon className={cn("size-4 text-white", classList?.icon)} />
...
export const CarouselNext = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ArrowRightIcon className={cn("size-4 text-white", classList?.icon)} />
