...
import type { InfiniteComboboxProps } from "../infinite-combobox";
...
type FieldPropsMap = {
  ...
  otp: OTPInputProps;
  "multi-select": MultiSelectProps;
  "infinite-combobox": InfiniteComboboxProps<any>;
};
...
export type {
  ...
  FieldValues,
  FormConfig,
  InferFormReturn as InferredFormFields,
  InferZodSchema as InferredSchema,
