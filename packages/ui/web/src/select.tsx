...
import { popoverContentVariants, popoverItemVariants } from "./_styles";
...
const selectTriggerVariants = cva("flex items-center border-border", {
  variants: {
    variant: {
      default:
        "h-9 w-full min-w-56 justify-between whitespace-nowrap rounded-md border border-border bg-accent px-3 py-2 text-sm ring-offset-background placeholder:text-foreground-dimmed focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
...
export const SelectItem = ({
  ...
  <SelectPrimitive.Item
    className={cn(
      popoverItemVariants(),
      "w-full pr-8 text-sm outline-none focus:bg-background focus:text-foreground-rich data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
